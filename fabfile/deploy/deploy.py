...
from ..utils import update_esr21_conf


def deploy(requirements_list=None, conf_filename=None, bootstrap_path=None, release=None,
           map_area=None, user=None, bootstrap_branch=None, skip_update_os=None, skip_db=None,
           skip_restore_db=None, skip_repo=None, skip_venv=None, skip_mysql=None,
           skip_python=None, skip_web=None, update=None, current_tag=None,
           skip_collectstatic=None, skip_bash_config=None, skip_keys=None,
           work_online=None, specific_tag=None):
    ...
    if update:
        env.fabric_config_path = os.path.expanduser(os.path.join(
            '/Users/esr21/source', env.project_repo_name, 'fabfile/conf', env.fabric_conf))
        update_fabric_env()
